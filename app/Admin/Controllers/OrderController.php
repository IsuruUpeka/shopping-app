...
use App\Admin\Actions\Order\Analytics;
...
use App\Admin\Actions\Order\ExportPdf;
use App\Admin\Actions\Order\SinglePagePdf;
...
class OrderController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        */
        ...
        $grid->column('delivery_address', __('Delivery details'));
        ...
        $grid->tools(function (Grid\Tools $tools) {
            $tools->append(new ExportPdf());
        });

        $grid->tools(function (Grid\Tools $tools) {
            $tools->append(new Analytics());
        });

        $grid->actions(function ($actions) {
            $actions->append('<a href="/pdf/single_order" target="_blank">PDF</a>');
            $actions->add(new SinglePagePdf());
        });
